...
import { BookOpen, Eye, EyeOff, Loader2, Mail, Lock, User, CheckCircle } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Bergabung dengan EduKelas</h1>
          <p className="text-gray-600">Mulai perjalanan belajar Anda hari ini</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-xs text-gray-500 space-y-1">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li className={formData.password.length >= 6 ? "text-green-600" : ""}>Minimal 6 karakter</li>
                  <li
                    className={
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600 mb-4">Dengan bergabung, Anda mendapatkan:</p>
